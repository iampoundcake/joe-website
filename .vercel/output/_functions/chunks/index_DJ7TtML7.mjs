const id = "2024-04-24/index.md";
						const collection = "dailies";
						const slug = "2024-04-24";
						...
						const data = {title:"No. 4",description:"an avalanche of logistics incoming",publishDate:"24 Apr 2024",coverImage:{src:"./omfbb-mqcxl.webp",alt:""},tags:["rested","content"],draft:false};
						const _internal = {
							type: 'content',
							filePath: "D:/joe-website/src/content/dailies/2024-04-24/index.md",
							rawData: undefined,
						};
