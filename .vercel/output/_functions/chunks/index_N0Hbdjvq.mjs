const id = "2024-04-21/index.md";
						const collection = "weeklies";
						const slug = "2024-04-21";
						...
						const data = {title:"No. 1",description:"a casual sunday",publishDate:new Date(1713672000000),coverImage:{src:
						new Proxy({"src":"/_astro/rigatonez.D_LUHt4v.jpg","width":1106,"height":1324,"format":"jpg","fsPath":"D:/joe-website/src/content/weeklies/2024-04-21/rigatonez.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/joe-website/src/content/weeklies/2024-04-21/rigatonez.jpg";
							}
							
							return target[name];
						}
					})
					,alt:"the all-day sunday sauce with rigatoni"},draft:false,tags:["good","anticipatory"]};
						const _internal = {
							type: 'content',
							filePath: "D:/joe-website/src/content/weeklies/2024-04-21/index.md",
							rawData: undefined,
						};
