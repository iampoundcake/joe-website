const id = "2024-04-29/index.md";
						const collection = "weeklies";
						const slug = "2024-04-29";
						...
						const data = {title:"No. 9",description:"the american dream.",publishDate:new Date(1714363200000),coverImage:{src:
						new Proxy({"src":"/_astro/IMG_2353.CsEdyq6R.JPG","width":1080,"height":1440,"format":"jpg","orientation":1,"fsPath":"D:/joe-website/src/content/weeklies/2024-04-29/IMG_2353.JPG"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/joe-website/src/content/weeklies/2024-04-29/IMG_2353.JPG";
							}
							
							return target[name];
						}
					})
					,alt:"we ... own a home!?"},draft:false,tags:["excited","nervous"]};
						const _internal = {
							type: 'content',
							filePath: "D:/joe-website/src/content/weeklies/2024-04-29/index.md",
							rawData: undefined,
						};
