const id = "2024-04-25/index.md";
						const collection = "weeklies";
						const slug = "2024-04-25";
						...
						const data = {title:"No. 6",description:"going dark mode for the next few days",publishDate:new Date(1714017600000),coverImage:{src:
						new Proxy({"src":"/_astro/IMG_5013.B6pjof2O.jpg","width":900,"height":675,"format":"jpg","orientation":1,"fsPath":"D:/joe-website/src/content/weeklies/2024-04-25/IMG_5013.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/joe-website/src/content/weeklies/2024-04-25/IMG_5013.jpg";
							}
							
							return target[name];
						}
					})
					,alt:""},draft:false,tags:["excited","“unmotivated\""]};
						const _internal = {
							type: 'content',
							filePath: "D:/joe-website/src/content/weeklies/2024-04-25/index.md",
							rawData: undefined,
						};
