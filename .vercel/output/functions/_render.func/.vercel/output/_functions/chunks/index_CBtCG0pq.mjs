const id = "2024-04-30/index.md";
						const collection = "weeklies";
						const slug = "2024-04-30";
						...
						const data = {title:"No. 10",description:"three cheers for the birthday boi",publishDate:new Date(1714449600000),coverImage:{src:
						new Proxy({"src":"/_astro/img_0430.DYcWa-qY.jpg","width":748,"height":533,"format":"jpg","fsPath":"D:/joe-website/src/content/weeklies/2024-04-30/img_0430.jpg"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "D:/joe-website/src/content/weeklies/2024-04-30/img_0430.jpg";
							}
							
							return target[name];
						}
					})
					,alt:"katie always gets me two cards 😍."},draft:false,tags:["good","happy"]};
						const _internal = {
							type: 'content',
							filePath: "D:/joe-website/src/content/weeklies/2024-04-30/index.md",
							rawData: undefined,
						};
